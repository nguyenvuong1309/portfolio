...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/vuong-nguyen-a2466a2a2/}{https://linkedin.com/vuong-nguyen-duc}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
    ...
    \section{Summary}
        ...
        \begin{onecolentry}
            Full-Stack Developer with 1.5+ years of experience building scalable web and mobile applications. Specialized in React, React Native, Django backend development. Proven track record of delivering a production application with 5K+ active users and successful App Store/Google Play deployments. Expertise in CI/CD automation, security implementation (HttpOnly cookies), performance optimization, and Agile development methodologies. Strong background in API design, database optimization, and cross-functional team collaboration.
        \end{onecolentry}
